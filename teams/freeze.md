...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align:center">
        <p>
          <img src="https://firebasestorage.googleapis.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-MgIuSiDFSNyVZCB3uMq%2F-MgIuUXknAZ_f4rq6m4c%2F-MgIxnnOW7jeltr-TYkK%2FUI_AvatarIcon_Tartaglia.png?alt=media&amp;token=53789ccf-0adf-4468-8e1a-5e73f27f5d67"
          alt/>
        </p>
        <p>Childe</p>
      </td>
      ...
      <td style="text-align:left">
        <ul>
          <li>Can work well with either Mona or Xingqui. Ayaka has an abundance of Cryo
            ...
            Elemental Burst.</li>
          <li>Can also be used as a burst support and battery.</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        <ul>
          <li>Can be used as the hydro applier with off field Cryo support(s) to freeze.
            Along with a character that can provide grouping CC, Childe can deal incredible
            amounts of AOE damage.</li>
          <li>Note: not as effective as using a Cryo main DPS as Cryo characters benefit
            more from the 4pc Blizzard Strayer set.</li>
        </ul>
      </td>
    </tr>
  </tbody>
      ...
      <td style="text-align:left">
        <ul>
          <li>Provides an off field Elemental Burst that damages and applies Cryo around
            every 2 seconds.</li>
          <li>Can buff the team&apos;s Crit Rate (up to 15%) at Ascension 4.</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <ul>
          ...
          <li>Can not work with certain characters at Constellation 6.</li>
        </ul>
      </td>
    </tr>
    <tr>
...
* Morgana - the classic freeze comp focused around utilizing Ganyu, Mona, and Venti's Elemental Burst together and DPS with Ganyu's Charged Attacks, dealing massive AOE damage with her blooms and Elemental Burst. Can replace Ganyu with Ayaka and Venti with Kazuha/Sucrose. 
...
* Similar to Morgana, this comp focuses around the Elemental Bursts and using Ayaka's Normal and Charged Attacks for additional DPS. 
