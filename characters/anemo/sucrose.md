...
* **Elemental Skill** creates a small Wind Spirit that pulls opponents towards it's location and launches up opponents within it's AoE into the air.
...
* **A1 **raises the **Elemental Mastery** of all characters besides Sucrose whenever Sucrose triggers a **Swirl** reaction.
  * This **Elemental Mastery **Buff only applies to characters matching the element she **Swirls** with.
* **A4** allows Sucrose to share 20% of her **Elemental Mastery** with her team members when her **Elemental Skill** or **Elemental Burst** hits an opponent.
  * Sucrose can reach **Elemental Mastery** values as high as 1000 which would give 250 **Elemental Mastery** to her party members with both **A1** and **A4** talents.
...
* Sucrose can act as an Energy Battery for other **Anemo** characters, while those other **Anemo** characters can in turn act as Energy Batteries for Kazuha, as well. She is especially good with her **C1.**
...
* **Anemo **cannot cause **Elemental **Reactions with **Geo** and **Viridescent Venerer** cannot provide Debuffing for **Geo **and** Physical **Damage characters.
  * She can however could still be used for Crowd Control.
...
{% hint style="info" %}
In all the teams listed below, Sucrose universally provides Debuffing using the **Viridescent Venerer** 4-set and can also provide boosts to multiple elemental damage types.
{% endhint %}
...
* Often referred to as the Taser team, this team makes use of **Electro** and **Hydro** off-field DPS while Sucrose creates **Swirl** Reactions with her **Elemental Skill, Normal Attacks** and **Charged Attacks**, buffing the teams' **Elemental Mastery** while decreasing enemies **Electro** and **Hydro** Resistance.
...
* Sucrose's **Elemental Burst** can infuse with **Pyro** allowing the **Cryo** Main DPS to **Reverse Melt.** Her **Elemental Mastery** buff also helps the **Cryo** Main DPS to deal more **Reverse Melt** damage.&#x20;
