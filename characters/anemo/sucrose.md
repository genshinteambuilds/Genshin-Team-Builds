...
* **Support**: Buffer (Ascension 4, Constellation 6), Debuffer (VV), Crowd Control (Grouping), Energy Battery
...
* **Ascension 1 **raises the **Elemental Mastery** of all characters besides Sucrose whenever Sucrose triggers a **Swirl** reaction.
  * This **Elemental Mastery **Buff only applies to characters matching the element Sucrose **Swirls**.
* **Ascension 4** allows Sucrose to share 20% of her **Elemental Mastery** with her team members when her **Elemental Skill** or **Elemental Burst** hits an opponent.
...
* **Constellation 1** gives her **Elemental Skill** an additional charge.
* **Constellation 6** allows Sucrose to boost **Elemental** Damage by 20% for the element absorbed by her Elemental Burst.
